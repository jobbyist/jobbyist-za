      ...
      <div className="container mx-auto px-4 relative">
        <div className="max-w-5xl mx-auto text-center">
          ...
          <p className="text-slate-700 max-w-2xl mx-auto mb-12">
            Sign up for early access to our comprehensive HR management solution launching Q4 2026.
          </p>
          ...
          <p className="text-sm text-muted-foreground mt-6 flex items-center justify-center gap-2">
            ...
            Launching October 2026 • Free early access registration • Priority access for early adopters
          </p>
        </div>
      </div>
    </section>
